...
window.webcam = {
	...
	swf_url: '../../bundles/minicosilver/jpegcamera/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: '../../bundles/minicosilver/jpegcamera/shutter.mp3', // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : '../../bundles/minicosilver/jpegcamera/shutter.mp3';
	},
